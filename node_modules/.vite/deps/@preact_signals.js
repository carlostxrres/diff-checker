...
var l3;
var p2;
var m = "undefined" != typeof window && !!window.__PREACT_SIGNALS_DEVTOOLS__;
var w2 = [];
var _2 = [];
E(function() {
  h2 = this.N;
...
g2("__r", function(i2, n2) {
  ...
  if (n2.type !== k) {
    ...
    if (f2) {
      f2.__$f &= -2;
      if (void 0 === (t3 = f2.__$u)) f2.__$u = t3 = (function(i3) {
        var n3;
        E(function() {
          n3 = this;
        });
...
function k2(i2, n2, t3, r2) {
  var f2 = n2 in i2 && void 0 === i2.ownerSVGElement, o2 = d2(t3);
  return { o: function(i3, n3) {
    o2.value = i3;
    r2 = n3;
  }, d: E(function() {
    this.N = M;
    var t4 = o2.value.value;
    if (r2[n2] !== t4) {
      r2[n2] = t4;
      if (f2) i2[n2] = t4;
      else if (null != t4 && (false !== t4 || "-" === n2[4])) i2.setAttribute(n2, t4);
...
var q = "undefined" == typeof requestAnimationFrame ? setTimeout : function(i2) {
  var n2 = function() {
    clearTimeout(t3);
...
function x2() {
  if (1 === w2.push(this)) (l.requestAnimationFrame || q)(T2);
}
function F() {
  r(function() {
    var i2;
    while (i2 = _2.shift()) h2.call(i2);
  });
}
function M() {
  if (1 === _2.push(this)) (l.requestAnimationFrame || A2)(F);
}
